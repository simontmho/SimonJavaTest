...
import com.thisisnoble.javatest.impl.SimonOrchestrator;
...
//        assertEquals(50.0, re2.getRiskValue(), 0.01);
        assertEquals(25.0, re2.getRiskValue(), 0.01);	// it seem the expected value is wrong.. isn't it??
        MarginEvent me2 = ce.getChildById("ship2-marginEvt");
        assertNotNull(me2);
//        assertEquals(10.0, me2.getMargin(), 0.01);
        assertEquals(5.0, me2.getMargin(), 0.01);		// it seem the expected value is wrong.. isn't it??
    }
